...
layout: post
title: Python quiz
description: This is the code for a quiz created using Python.
type: hacks
courses: { compsci: {week: 2} }
---

## Welcome to the quiz! 
This quiz includes terms from the 'Python IO' blog. The Python code for the quiz is as follows:
...
percentage = correct/questions * 100 #calculating the percentage scored on the quiz
